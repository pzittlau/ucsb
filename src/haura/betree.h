 ...
 */
struct database_t *betree_build_db(const struct cfg_t *cfg, struct err_t **err);
 ...
 */
void betree_close_db(struct database_t *db);
 ...
 */
struct database_t *betree_create_db(const struct cfg_t *cfg, struct err_t **err);
 ...
 */
int betree_create_ds(struct database_t *db,
                     const char *name,
                     unsigned int len,
 ...
 */
struct obj_store_t *betree_create_object_store(struct database_t *db,
                                               const char *name,
 ...
 * for this data set.
 */
int betree_create_snapshot(struct database_t *db,
                           struct ds_t *ds,
                           const char *name,
                           unsigned int len,
                           struct err_t **err);
 ...
 */
int betree_delete_snapshot(struct database_t *db,
                           struct ds_t *ds,
                           const char *name,
                           unsigned int len,
                           struct err_t **err);
 ...
 * store an error in `err`.
 */
struct name_iter_t *betree_iter_datasets(struct database_t *db, struct err_t **err);
 ...
 * store an error in `err`.
 */
struct name_iter_t *betree_iter_snapshots(const struct database_t *db,
 ...
 * On error, return null.  If `err` is not null, store an error in `err`.
 */
struct database_t *betree_open_db(const struct cfg_t *cfg,
                                  struct err_t **err);
 ...
 * On error, return null.  If `err` is not null, store an error in `err`.
 */
struct ds_t *betree_open_ds(struct database_t *db,
                            const char *name,
                            unsigned int len,
                            struct storage_pref_t storage_pref,
                            struct err_t **err);
 ...
 * Note that any existing database will be overwritten!
 */
struct database_t *betree_open_or_create_db(const struct cfg_t *cfg, struct err_t **err);
 ...
 * On error, return -1.  If `err` is not null, store an error in `err`.
 */
int betree_sync_db(struct database_t *db, struct err_t **err);
